---
name: hyp-watch
description: Watch live price updates for a ticker (streams for 30 seconds)
argument-hint: "<ticker> [seconds] - e.g., BTC 60"
---

## Watch Live Hyperliquid Prices

Stream live price updates via websocket for a specified duration.
...
Execute with: `python scripts/hyp_watch.py BTC [60]`
